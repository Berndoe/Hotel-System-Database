...
<form method="post" action="page_5_query.php">
	<div class="form control container">
		<p class="text-xl-center font-weight-bold">Generate Bill</p><hr style="width:400px; position: relative; left: -60px;">
		<div class="mb-3">
			<label style="padding-left: -200px;">Enter Guest ID</label><br>
			<input type="number" class="form-control" placeholder="Guest ID" name="id"><br>

			<div class="mb-3">
				<a href="page_5_query.php"><input class="btn btn-primary form control btn-block" type="submit" value="SELECT" name="Submit1"></a>
			</div>	
		</div>
	</div>
</form>
