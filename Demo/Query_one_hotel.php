...
<div class="w3-top" id="nav-placeholder">
		<ul class="topnav" title="Toggle Navigation Menu">
		  ...
		  <li><a  class="active" href="Query_one_hotel.php"> Room Availability </a></li>
	 ...
	 <?php
		...
		//write sql
		$sql = "SELECT roomType, COUNT(roomType) as NumberOfAvailableRooms FROM Room WHERE `availability` =1 GROUP BY roomType";
		...
		if ($result->num_rows > 0) 
		{
			  ...
			  while($row = $result->fetch_assoc()) 
			  {
				  	//add record to array 
				  	$rooms[] = $row["roomType"];
					$frequency[] = $row["NumberOfAvailableRooms"];		 
			   }//end of loop
	...
	var yValues = <?php echo json_encode($frequency); ?>;

	var barColors = ["red", "green","blue", "yellow", "purple", "pink", "black"];
